...
class PloggingInfoViewCreater {
    ...
    func addPloggingDistanceView(_ ploggingDistance: Double) {
        ...
        distanceIconImageView.frame = CGRect.init(x: DeviceScreen.screenWidth * 1/4, y: DeviceScreen.screenWidth * 2/4, width: 50, height: 50)
        ploggingInfoBaseView.addSubview(distanceIconImageView)
        
        let distanceLabel = UILabel(frame: CGRect(x: DeviceScreen.screenWidth * 1/4, y: DeviceScreen.screenWidth * 2/4 + 50, width: 150, height: 25))
    ...
    func addPloggingTimeView(_ ploggingTime: String) {
        ...
        timerIconImageView.frame = CGRect.init(x: DeviceScreen.screenWidth * 2/4, y: DeviceScreen.screenWidth * 2/4, width: 50, height: 50)
        ploggingInfoBaseView.addSubview(timerIconImageView)
        
        let timeLabel = UILabel(frame: CGRect(x: DeviceScreen.screenWidth * 2/4, y: DeviceScreen.screenWidth * 2/4 + 50, width: 150, height: 25))
