...
private extension CameraViewController {
    ...
    func addPloggingResultInfoView() {
        ...
        let ploggingInfoView = ploggingInfoViewCreater.createPloggingInfoView(distance: String(format: "%.2f", Float(ploggingResult?.distance ?? 0)/1000), trashCount: "\(trashCountSum)")
